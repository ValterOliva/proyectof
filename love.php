...
<html lang="es">  
  ...
  <body>   
  	...
  	if(isset($_GET['username'])) {
          ...
          $sqlAa = $mysqli->query("SELECT post FROM likes WHERE usuario = '".$rowA['id']."'");
          $rowAa = $sqlAa->fetch_array();
          

  		$sqlB = $mysqli->query("SELECT * FROM publicaciones WHERE id = '".$rowAa['post']."' ORDER BY id DESC");
